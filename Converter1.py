"""
converter1.py: A script to convert PDF files to text using OCR
Number 1 in the series of scripts to convert PDF files to text using OCR.

This script has errors and was not what I wanted to do.
This converts a PDF to a series of images, then uses OCR to convert the images to text.
